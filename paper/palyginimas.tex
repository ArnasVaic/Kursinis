...
% Iš rezultatų galima matyti, kad skaitinis modelis šiuo atveju veikia korektiškai. Taip pat galima atkreipti dėmesį į faktą, kad proceso metu trečios medžiagos kiekis $q_3$ išlieka

% Šis grafikas nėra ypatingai turiningas, tačiau svarbu įžvelgti esminius faktus - visų trijų medžiagų kiekiai sistemoje bėgant laikui nesikeičia, o trečios medžiagos kiekis visos simuliacijos metu yra lygus nuliui. Taigi, aišku, kad
