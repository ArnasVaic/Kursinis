...
Initial condition does not hold because Fourier series is missing $B_0$ term which can't really be added out of thin air. The solutions hold the general form of desired initial condition $u(x,0)=0$, but is not at the correct "height". Not sure if the problem lies in the formulation of the problem or the solution.